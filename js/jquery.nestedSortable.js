...
(function($) {
    ...
    $.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        _mouseDrag: function(event) {
            ...
            this.hovering = this.hovering || null;
            this.mouseentered = this.mouseentered || false;
            ...
            if (parentItem != null
                //&& nextItem == null
                && !(o.protectRoot && parentItem[0].parentNode == this.element[0]) && (o.rtl && (this.positionAbs.left + this.helper.outerWidth() > parentItem.offset().left + parentItem.outerWidth()) || !o.rtl && (this.positionAbs.left < parentItem.offset().left))) {
